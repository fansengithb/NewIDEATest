...
public class QrCodeCreateUtil {
    ...
    public static boolean createQrCodeNew(OutputStream outputStream, String content, int qrCodeSize, String imageFormat) throws WriterException, IOException {
        //设置二维码纠错级别ＭＡＰ
        Hashtable<EncodeHintType, ErrorCorrectionLevel> hintMap = new Hashtable<EncodeHintType, ErrorCorrectionLevel>();
        hintMap.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.L);  // 矫错级别
        QRCodeWriter qrCodeWriter = new QRCodeWriter();
...
//    	createQrCode("http://milk.hotkidclub.com/?phone=123456789777",900,"JPEG");
//        readQrCode(new FileInputStream(new File("d:\\www\\qrcode.jpg")));  
        System.out.println("读出二维码信息!");
    }  
